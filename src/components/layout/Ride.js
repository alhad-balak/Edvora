  ...
  return (
    <div className="ride">
      <div className="ride-image">
        <img src="https://previews.123rf.com/images/irfanfirdaus/irfanfirdaus1902/irfanfirdaus190200019/117794709-navigation-map-with-pin-pointer-vector-illustration-of-location-direction-city-map-with-navigation-f.jpg" alt="" className="ride-image" />
      </div>
